...
public class HomeTask5 {
    ...
    оно должно сообщить результат. (Например, dog1.run(150); -> результат: 'Пёсик пробежал!')
    ...
    public static void main(String[] args) {
       Cat cat1 = new Cat("black", "Kitcka");
        System.out.println(cat1.getLimitSwim());
       System.out.println(cat1.jump(1f));
       System.out.println(cat1.jump(3f));

       Cat cat2 = new Cat("multicolor","Masha");
       cat2.setLimitSwim(4f);
        System.out.println(cat2.getLimitSwim());
        System.out.println(cat2.swim(3f));
